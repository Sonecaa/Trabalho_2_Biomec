...
# Nome da biblioteca que deseja instalar
biblioteca = "numpy"

# Use o subprocess para executar o comando 'pip install' para a biblioteca
try:
    resultado = subprocess.check_output(["pip", "install", biblioteca])
    print(f"Instalação de '{biblioteca}' concluída com sucesso.")
except subprocess.CalledProcessError as e:
    print(f"Erro ao instalar '{biblioteca}': {e.output}")
